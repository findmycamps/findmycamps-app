    ...
    <header className="sticky top-0 z-50 w-full border-b border-[#ACDB95]/50 bg-[#FFFBEB]/80 backdrop-blur supports-[backdrop-filter]:bg-[#FFFBEB]/60">
      <div className="container flex h-16 max-w-screen-2xl items-center justify-between text-[#00524C]">
        ...
        <nav className="hidden md:flex items-center space-x-2">
          ...
          <Button
            variant="ghost"
            className="hover:bg-[#ACDB95]/30 font-semibold"
          >
            List a Camp
          </Button>
          ...
          {user ? (
            ...
            <>
              <span className="text-sm text-[#00524C]/80 hidden lg:inline">
                {user.email}
              </span>
              <Button
                variant="ghost"
            ...
            <Link href="/auth" passHref>
              <Button className="bg-[#00524C] text-[#FFFBEB] hover:bg-[#00524C]/90 font-semibold">
                Login
              </Button>
            </Link>
          )}
      ...
      {isMenuOpen && (
        <div className="md:hidden px-4 pt-2 pb-4 border-t border-[#ACDB95]/50 bg-[#FFFBEB]">
          <nav className="flex flex-col space-y-2 text-[#00524C]">
            <Button
              variant="ghost"
              className="hover:bg-[#ACDB95]/30 font-semibold w-full justify-start"
            >
              List a Camp
            </Button>
            {user ? (
              ...
              <Link href="/auth" passHref>
                <Button className="bg-[#00524C] text-[#FFFBEB] hover:bg-[#00524C]/90 font-semibold w-full">
                  Login
                </Button>
              </Link>
            )}
