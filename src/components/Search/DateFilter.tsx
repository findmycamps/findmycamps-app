...
export const DateFilter: React.FC<DateFilterProps> = ({ dateRange, onChange }) => {
  const [isOpen, setIsOpen] = useState(false);
  const [selectingPhase, setSelectingPhase] = useState<'start' | 'end' | 'complete'>('start');
          ...
          <div className="p-3 border-b bg-muted/20">
            ...
            {tempStart && selectingPhase === 'end' && (
              <p className="text-xs text-muted-foreground">
                Start: {tempStart.toLocaleDateString('en-US', { 
                  month: 'short', 
                  day: 'numeric',
                  year: 'numeric' 
                })}
