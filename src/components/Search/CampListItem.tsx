...
export const CampListItem: React.FC<CampListItemProps> = ({ camp, onClick }) => {
  const CampThumbnail = ({ camp }: { camp: GroupedCamp }) => {
    ...
    return (
      <div className={`flex h-full w-full items-center justify-center rounded-l-lg ${bgColor}`}>
            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-sm text-muted-foreground mb-3">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>
                    {firstSession?.location?.city || 'N/A'}, {firstSession?.location?.province || 'N/A'}
                  </span>
                </div>
                <div className="flex items-center gap-1">
